...
public class BookController {
    ...
    //connectedUser ở đây là người mượn
    @GetMapping("/borrowed")
    ...
    //connectedUser ở đây là chủ sách
    @GetMapping("/returned")
    ...
    public ResponseEntity<Integer> updateArchiveStatus(@PathVariable("book-id") Integer bookId, Authentication connectedUser) {
